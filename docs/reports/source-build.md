...
The latest bounded live refresh completed at `2026-09-12T10:04:34.480Z` UTC (`06:04:34 EDT`). Its compact capture is in [`data/seed/observations.json`](../../data/seed/observations.json). Raw HTML is retained locally under `data/raw/` (ignored by Git), including the timestamped CMU, Lobos index, Lobos Bentley detail, and Reinhold responses.
...
VALID 41 homes, 410 evidence rows, 3 imported source runs
```
